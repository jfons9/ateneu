...
//$conf['savedir']     = '/dades/wikiform/data';          //where to store all the files
$conf['savedir']     = '../wikiform/data';          //where to store all the files
...
$conf['template']    = 'm1ateneu';         //see lib/tpl directory
