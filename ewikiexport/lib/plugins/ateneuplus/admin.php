...
/**
 * ateneuplus: Complements per a wikiexport a ateneu
 * 
 ...
 */
class admin_plugin_ateneuplus extends DokuWiki_Admin_Plugin {
    ...
    function handle() {
        ...
        $this->_group2user();
/*
        $helper = $this->loadHelper('ateneuplus'); // or $this->loadHelper('tag', true);
        if ($helper) {
 ...
 */
    ...
    function _gestiona() {
        ...
        ptln('<form action="index?do=admin&page=ateneuplus&show=gestiona" method="post">');
...
//        echo $this->locale_xhtml('help');
    ...
    function menu() {
        $separador = " | ";
        $menu = "<a href='/wikiform/wikiform/?do=admin&page=ateneuplus'>Inici</a>" . $separador .
                "<a href='/wikiform/wikiform/?do=admin&page=ateneuplus&show=infocursos'>Info cursos</a>" . $separador .
                "<a href='/wikiform/wikiform/?do=admin&page=ateneuplus&show=gestiona'>Estats i unitats cursos</a>" . $separador .
                "<a href='/wikiform/wikiform/?do=admin&page=ateneuplus&show=infosistema'>Sistema</a>" . $separador .
