...
<div id="dokuwiki__header">
        ...
        <div id="m1-header-center"> <!--Logo and main center image -->
            	...
            	//user defined PNG
            	echo "><img src=\"".DOKU_TPL."images/logo.png\" class=\"m1-imglogo\" alt=\"Departmanet d'ensenyament\"/></a></h1>\n";
        		}elseif (file_exists(DOKU_TPLINC."images/logo2.gif")){
            	//user defined GIF
            	echo "><img src=\"".DOKU_TPL."images/logo2.gif\" class=\"m1-imglogo\" alt=\"Departmanet d'ensenyament\"/></a></h1>\n";
  	...
  	<?php
           // demanem  generació de menú via helper 
           $helper = plugin_load('helper', 'ateneuplus');        
            
           $menu = $helper->get_menu($ID, 'm1-menu');
           print('<div id="m1-menu"> <ul id="navlist">\n');
           print($menu);
           print('</ul></div>');
        ?>
            <div id="m1-search">
