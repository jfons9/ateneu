                        ...
                        <?php
                            ...
                            $data = array(
                                ...
                                'items' => array(
                                    ...
                                    'export'    => '<li><a href="'.$exporta.'" class="action" accesskey="t" rel="nofollow" title="Visualitza pàgina a wikiexport (pestanya a part)" target="_new"><span>Exporta</span></a></li>'
                                )
                            );
